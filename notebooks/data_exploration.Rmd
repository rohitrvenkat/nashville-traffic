...
roads <- road_segments %>%
  ...
  ungroup() %>%
  left_join(traffic_segments %>% st_drop_geometry()) %>%
  group_by(MSLINK) %>%
...
saveRDS(davidson_county_pop_data, "../shiny_app/data/davidson_county_pop_data.rds")
```
...
saveRDS(zip_code_pop_data, "../shiny_app/data/zip_code_pop_data.rds")
```
